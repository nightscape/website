...
import ExpandableJob, { ExpandableJobProps } from '../components/ExpandableJob'
...
const jobs: ExpandableJobProps[] = [
    {
        ...
        paragraphs: (<>
            <p>We at TypeFox specialize in building tools and we are looking to expand our team. Our mission is to make software development fun and remove all tedious friction. We are a highly motivated team, organized in a flat hierarchy, and led by technical founders. We love open source, have started and lead many popular open-source projects, and contribute to many others. In this fashion, we present at international conferences and collaborate openly around the globe.</p>
            <p>What is exciting about tools is that your expertise benefits software developers as well as experts in many other fields. This includes electrical engineering, data science, mechanical engineering, healthcare, aerospace, insurance, finance, and many more. TypeFox helps customers from all over the world.</p>
        </>),
        lists: [
            {
    ...
    },
    {
        ...
        paragraphs: (<>
            <p>As a UX Developer, you will take care of the UI/UX design and development of Gitpod. You will become an essential part of a cross-functional team and directly work together with product management, development and marketing.</p>
        </>),
        lists: [
            {
                title: 'What you will do:',
